/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 4055d480b2e659c784d5be3cf83a279a)
// Runtime types generated with workerd@1.20260710.1 2024-12-30
interface __BaseEnv_CloudflareBindings {
  ...
  SYNCER_SERVICE_API: string;
  SYNCER_API_TOKEN: string;
  NODE_ENV: string;
}
